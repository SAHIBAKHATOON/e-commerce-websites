...
const productdetails = () => {
  ...
  const {  updateCartItemCount, removeToCart, addToCart, cartItems, closeProductDetails,
  ...
  return (
   ...
   <div  className="d-flex ">
    ...
    <p className='my-3'>Was <strike className='text-danger' >{product.price*2}</strike>&nbsp; Now <span className="price">
     ...
     <p className='mb-3'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Repudiandae 
      sunt dolor saepe facere doloremque odit eveniet laborum voluptates delectus ut.</p>
    </div>
  ...
  <input type="text" className="form-control" placeholder="Enter a coupon code ..."  
